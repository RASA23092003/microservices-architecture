...
public class OrderAPI {
	...
	ResponseEntity<String> placeOrder(@RequestBody OrderDTO orderDTO) throws EPharmacyException {
		...
		String paymentResponse=restTemplate.postForObject("http://Epharmacy-PaymentMS/epharmacy/payment-api/payment/amount/"+order.getOrderValueAfterDiscount(), orderDTO.getCard(), String.class);
